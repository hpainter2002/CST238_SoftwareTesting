...
class TestJobStories(TestCase):
    ...
    @JobStory(
            "When I ask \"Which is the best restaurant around here?\" I want to receive the answer \"Use a search engine idiot!\".")
    ...
    @JobStory(
            "When I ask \"How is the weather going to be tomorrow?\" I want to receive the answer \"Check your weather app!\"")
